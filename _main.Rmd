...
```{r 01_load-data, message=FALSE, eval=FALSE}
...
```{r 02_dimRed_UMAP-vis, fig.width=5, fig.height=5, fig.show='hold'}
...
```{r 02_dges_vis-clst1, message=FALSE, fig.width=7, fig.height=7}
## Select genes
