...
The dataset a single sample from the dorsolateral prefrontal cortex (DLPFC) 10x Genomics Visium dataset, that was published by @Maynard2021-pq.
...
For more details, see the related publication from Righelli et al., 2021 describing the `SpatialExperiment` [@Righelli2022-lm].
